  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      <Link
        ...
        className="
        group relative col-span-6 row-span-6 rounded-lg 
      ...
      >
        ...
        <div
          ...
          max-w-[288px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5"
        >
      ...
      {otherProducts.map((product) => {
        return (
          <Link
            ...
            className="
            group relative col-span-3 row-span-3 rounded-lg 
            bg-zinc-900 overflow-hidden
            flex justify-center items-end"
          >
            <Image
